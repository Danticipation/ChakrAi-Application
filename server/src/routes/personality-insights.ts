  ...
  try {
    ...
    const enhancedResponse = {
      ...
      reflectionSummary: reflectionSummary || {
        personalityReflection: 'Your unique personality is being analyzed through our conversations',
        emotionalJourneyReflection: 'Your emotional patterns and growth are being tracked',
        therapeuticInsights: memoryContext.relevantInsights.slice(0, 5).map(i => i.insight || i.content || ''),
        growthAnalysis: 'Your personal growth trajectory is being monitored',
        strengthsAndGrowthAreas: {
          strengths: ['Self-awareness', 'Engagement with therapy', 'Willingness to explore'],
          growthAreas: ['Continued emotional exploration', 'Pattern recognition', 'Integration of insights']
        },
        therapeuticRecommendations: [
          'Continue journaling to deepen self-awareness',
          'Reflect on emotional patterns you\'ve noticed',
          'Practice applying insights to daily situations',
          'Maintain consistency in your therapeutic engagement'
        ]
      },
