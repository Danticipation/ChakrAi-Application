...
// Emergency restoration script for Chakrai application
import { execSync } from 'child_process';
import { writeFileSync, existsSync, mkdirSync } from 'fs';
import { join } from 'path';

console.log('🔧 Restoring Chakrai application...\n');

// Create package.json with working versions
const workingPackageJson = {
  "name": "chakrai-wellness",
  "version": "1.0.0",
  "type": "module",
  "scripts": {
    "dev": "node server.js",
...
console.log('📦 Creating stable package.json...');
writeFileSync('package.json', JSON.stringify(workingPackageJson, null, 2));
...
console.log('🚀 Creating working server...');
...
console.log('\n💡 Your Chakrai mental wellness app will be running at http://localhost:3000');